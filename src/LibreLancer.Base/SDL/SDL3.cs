...
*/
    ...
    */
    ...
    // Callum: Manual binding to work better
	[LibraryImport(nativeLibName)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
	public static partial SDLBool SDL_SetClipboardData(delegate* unmanaged<IntPtr,byte*,IntPtr,IntPtr> callback, delegate* unmanaged<IntPtr, void> cleanup, IntPtr userdata, IntPtr mime_types, UIntPtr num_mime_types);
...
*/
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate bool SDL_WindowsMessageHook(IntPtr userdata, MSG* msg);
    ...
    [LibraryImport(nativeLibName)]
    [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
    public static partial void SDL_SetWindowsMessageHook(SDL_WindowsMessageHook callback, IntPtr userdata);
/* SDL3_FULL
	[LibraryImport(nativeLibName)]
	[UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
